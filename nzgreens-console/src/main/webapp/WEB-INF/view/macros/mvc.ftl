...
<#--
 * 国家下拉框。
 * <@s.countrySelect></@s.countrySelect>
 -->
<#macro countrySelect>
    <option value="172">中国</option>
    <option value="4">阿根廷</option>
    <option value="5">阿联酋</option>
    <option value="32">博茨瓦纳</option>
    <option value="154">新西兰</option>
    <option value="93">马来西亚</option>
    <option value="153">新加坡</option>
    <option value="163">印度</option>
    <option value="164">印度尼西亚</option>
    <option value="47">菲律宾</option>
</#macro>
