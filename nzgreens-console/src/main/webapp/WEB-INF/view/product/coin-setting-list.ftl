        ...
        <div class="col-sm-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <@sec.any name="COIN_SETTING_UPDATE">
                        <div class="row">
                            <div class="col-sm-3">
        ...
        <div class="modal-content animated fadeIn" style="width: 500px">
            ...
            <div class="modal-body">
                <form id="addForm" method="post" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4 control-label" style="text-align: left; width: 20%">人民币</label>
                        <div class="col-sm-6">
                            <input name="money" class="form-control" id="addMoney">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label" style="text-align: left; width: 20%">金币</label>
                        <div class="col-sm-6">
                            <input type="number" name="coin" class="form-control" id="addCoin">
                        </div>
                    </div>
                </form>
            </div>
...
<textarea id="detailTr-template" style="display: none;">
    <form id="detailForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label" style="text-align: left; width: 20%">人民币</label>
            <div class="col-sm-6">
                <input name="money" class="form-control" id="updateMoney">
            </div>
        </div>
        <div class="hr-line-dashed"></div>
        <div class="form-group">
            <label class="col-sm-4 control-label" style="text-align: left; width: 20%">金币</label>
            <div class="col-sm-6">
                <input type="number" name="coin" class="form-control" id="updateCoin">
            </div>
        </div>
        <div class="hr-line-dashed"></div>
    </form>
...
<textarea id="tr-template" style="display: none;">
    {#if $T.data.total>0}
        ...
        <tr>
            <td>{$T.agent.id}</td>
            <td>{Fen2Yuan($T.agent.money)}</td>
            <td>{Fen2Yuan($T.agent.coin)}</td>
...
<script src="${ctx}${getVersion('js/product/coin-setting-list.js')}"></script>
</body>
