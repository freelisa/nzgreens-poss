...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <@sec.any name="SEARCH_KEYWORD_UPDATE">
                        <div class="row">
                            <div class="col-sm-3">
        ...
        <div class="modal-content animated fadeIn" style="width: 500px">
            ...
            <div class="modal-body">
                <form id="addForm" method="post" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4 control-label" style="text-align: left; width: 20%">关键字</label>
                        <div class="col-sm-6">
                            <input name="keyword" class="form-control" id="addKeyword">
                        </div>
                    </div>
                </form>
            </div>
...
<textarea id="detailTr-template" style="display: none;">
    <form id="detailForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label" style="text-align: left; width: 20%">关键字</label>
            <div class="col-sm-6">
                <input name="keyword" class="form-control" id="updateKeyword" value="{$T.data.keyword}">
            </div>
        </div>
    </form>
</textarea>
...
<script src="${ctx}${getVersion('js/product/search-keyword-list.js')}"></script>
</body>
