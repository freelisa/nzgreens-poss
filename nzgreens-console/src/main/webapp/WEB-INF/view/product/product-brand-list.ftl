        ...
        <div class="col-sm-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <@sec.any name="PRODUCT_BRAND_UPDATE">
                        <div class="row">
                            <div class="col-sm-3">
        ...
        <div class="modal-content animated fadeIn" style="width: 500px">
            ...
            <div class="modal-body">
                <form id="addForm" method="post" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4 control-label" style="text-align: left; width: 20%">品牌名称</label>
                        <div class="col-sm-6">
...
<script src="${ctx}${getVersion('js/product/product-brand-list.js')}"></script>
</body>
